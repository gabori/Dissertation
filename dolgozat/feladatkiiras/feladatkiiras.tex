...
\end{center}
\vskip 0.5cm
Gábori Péter Márk (TECWTE) mérnökinformatikus jelölt részére.\newline

\noindent\textbf{A szakdolgozat tárgyköre:} webalkalmazás-fejlesztés, adatbáziskezelés \newline

\noindent\textbf{A szakdolgozat címe:} Éttermi rendelésnyilvántartó rendszer\newline

\noindent\textbf{A feladat részletezése:}

Webalkalmazás készítése éttermek és rendelések adatainak nyilvántartásához. Felhasználói felület létrehozása webes környezetben HTML5 és AngularJS segítségével. Felhasználók segítése különféle szűrési lehetőségekkel, javaslattétellel az előzetes rendelések alapján.

Szerver oldalon Python/Flask keretrendszer kerül majd felhasználásra. Az adatokat relációs adatbázis tárolja majd amelyhez a keretrendszer SQLAlchemy ORM-en keresztül csatlakozik.
